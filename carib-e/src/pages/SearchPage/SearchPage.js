...
export const SearchPage = () => {
  ...
  const handleOnchangeQuery = (event) => {
    ...
    console.log(
      query,
      'searched query - we will further apply product filtering based on this query state'
    );
  };
  const onSubmitQuery = (e) => {
    e.preventDefault();
    console.log('here applying filtering of products ');
  };
  ...
  const onAddToWishList = () => {
    console.log('snackbar show for added to wishlist');
  };
